          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {filteredServices.length === 0 && (
              <div className="text-center py-16">
                <p className="text-xl text-gray-600 mb-4">No services found matching "{searchQuery}"</p>
                <p className="text-gray-500">Try a different search term or browse all services</p>
              </div>
            )}
          </div>
        </section>
