    ...
    resources: {
      ar: {
        translation: {
          ...
          tasker: {
            dashboardTitle: 'لوحة تحكم المهمات',
            dashboardWelcome: 'مرحباً',
            applicationUnderReview: 'طلبك قيد المراجعة',
            applicationUnderReviewDesc: 'تم استلام طلبك ومستنداتك. سنقوم بمراجعة طلبك والتحقق من هويتك. ستتمكن من تصفح المهام واستقبال العروض بعد الموافقة على طلبك.',
            viewApplicationStatus: 'عرض حالة التقديم',
            offeredTasks: 'عروض واردة',
            completedTasks: 'مهام مكتملة',
            totalEarnings: 'إجمالي الأرباح (EGP)',
            reviews: 'تقييم',
            profileCompletePrompt: 'أكمل ملفك الشخصي',
            loadError: 'فشل تحميل لوحة التحكم',
            emptyStateTitle: 'أنت جاهز للبدء',
            emptyStateDesc: 'لم تكمل أي مهام بعد. تصفح المهام المفتوحة للعروض وابدأ تقديم عروضك.',
            browseOpenForBids: 'تصفح المهام المفتوحة',
            quickLinks: 'وصول سريع',
            myOffers: 'عروضي',
            quoteRequests: 'طلبات السعر',
            openForBids: 'مهام مفتوحة للعروض',
      ...
      en: {
        translation: {
          ...
          tasker: {
            dashboardTitle: 'Tasker Dashboard',
            dashboardWelcome: 'Welcome',
            applicationUnderReview: 'Application under review',
            applicationUnderReviewDesc: 'We have received your application and documents. Our team will review and verify your identity. You will be able to browse tasks and receive offers once your application is approved.',
            viewApplicationStatus: 'View application status',
            offeredTasks: 'Offers received',
            completedTasks: 'Tasks completed',
            totalEarnings: 'Total earnings (EGP)',
            reviews: 'reviews',
            profileCompletePrompt: 'Complete your profile',
            loadError: 'Failed to load dashboard',
            emptyStateTitle: 'You\'re all set',
            emptyStateDesc: 'You haven\'t completed any tasks yet. Browse open-for-bid tasks to start offering your services.',
            browseOpenForBids: 'Browse open tasks',
